...
def transceiver(input_text, encoding_dict, d, n_pilot, K, G, boost_factor, punctured_bit, use_online_channel=False):
    ...
    input_pilot         = [+d * boost_factor, +d * boost_factor] * n_pilot              # Create pilot
    ...
    input_puncture      = puncture(input_modulate, punctured_bit, K)                    # Puncture
    ...
    output_depuncture   = depuncture(output_corrected, punctured_bit, K)                # Depuncture
